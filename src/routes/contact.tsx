...
function ContactPage() {
  ...
  const channels = [
    ...
    { Icon: Phone, label: c.channelCrisisLabel, v: c.crisisHotline, href: "tel:123" },
  ];
    ...
    <SiteShell>
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-5xl px-5 pb-12 pt-hero-under-site-header md:px-8">
          ...
          <h1 className="hero-title hero-title-xl mt-4 font-display text-5xl leading-[1.05] tracking-tight md:text-7xl">{c.heroTitle}</h1>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start gap-4 rounded-3xl border border-border/70 bg-card p-5">
            ...
            <div>
              ...
              <p className="mt-1 text-sm">{c.studioAddress}</p>
            </div>
          </div>
        </div>
