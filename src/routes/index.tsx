      ...
      <div className="relative mx-auto grid max-w-7xl gap-10 px-5 pb-20 pt-hero-under-site-header md:px-8 lg:grid-cols-12 lg:gap-8">
        <div className="lg:col-span-7">
          <motion.div
            ...
            className="mt-2 inline-flex items-center gap-2 rounded-full border border-border bg-card/60 px-3 py-1 text-xs font-medium text-ink-muted backdrop-blur"
          >
...
function ForWho() {
  ...
  const cards = [
    ...
    { Icon: Stethoscope, title: t.home.therapistsTitle, body: t.home.therapistsBody, bg: "bg-mint/45" },
  ];
  return (
