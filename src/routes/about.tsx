...
const teamMembers = [
  { name: "Menna Mohamed", roleEn: "UI/UX · AI Implementation", roleAr: "واجهات المستخدم · تنفيذ الذكاء الاصطناعي", color: "bg-lavender/60" },
  { name: "Mohamed Ahmed", roleEn: "Frontend", roleAr: "تطوير الواجهة الأمامية", color: "bg-blush/60" },
  { name: "Raneem Elsaeed", roleEn: "Database engineer", roleAr: "مهندسة قواعد بيانات", color: "bg-aqua/50" },
  { name: "Merna Mohamed", roleEn: "Backend", roleAr: "تطوير الخلفية", color: "bg-cream" },
] as const;
